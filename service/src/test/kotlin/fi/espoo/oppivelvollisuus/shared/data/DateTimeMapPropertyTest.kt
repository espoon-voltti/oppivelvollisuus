...
import fi.espoo.oppivelvollisuus.dateTimeMap
...
class DateTimeMapPropertyTest : RangeBasedMapPropertyTest<HelsinkiDateTime, HelsinkiDateTimeRange, DateTimeMap<Int>>() {
