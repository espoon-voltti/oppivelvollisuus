...
import fi.espoo.oppivelvollisuus.common.Unauthorized
...
class ExceptionHandler : ResponseEntityExceptionHandler() {
    ...
    fun unableToExecuteStatementException(req: HttpServletRequest, ex: UnableToExecuteStatementException): ResponseEntity<ErrorResponse> {
