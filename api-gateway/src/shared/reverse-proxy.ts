...
// Configures the application to trust oppivelvollisuus AWS environment reverse proxies
...
export function trustReverseProxy(app: express.Application) {
  app.set('trust proxy', 3) // private ALB, oppivelvollisuus-proxy nginx, public ALB
